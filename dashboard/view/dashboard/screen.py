...
from dashboard.model.screen import DashboardScreen
from dashboard.model.graph import DashboardGraph
from dashboard import consts
from dashboard.utils.graph_urls import generate_graph_urls 
